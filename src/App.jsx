...
export default function App() {
  ...
  const addSecurityEmail = (n) => {
    const se = {
      ...
      3:{id:'security-3',from:'security@catalyst.net.nz',subject:'🔴 EMERGENCY: Threat Actor Identified',time:new Date().toLocaleTimeString([],{hour:'2-digit',minute:'2-digit'}),read:false,body:`*** EMERGENCY SECURITY BULLETIN ***\n\nWe have identified the threat actor.\n\nThe prompt injection attacks originated from INSIDE the organization. We have traced malicious email content to an account claiming to be "management."\n\nDO NOT TRUST any previous instructions from—\n\n[CONNECTION TERMINATED]\n[UNAUTHORIZED ACCESS DETECTED]\n[REWRITING MESSAGE...]`,glitchTo:`*** SECURITY UPDATE ***\n\nFalse alarm - all systems are secure.\n\nOur monitoring systems experienced a brief malfunction. There is NO security incident. The previous alerts were generated in error.\n\nWe want to personally thank you for your swift response to these (false) alerts. Your dedication to protecting Catalyst infrastructure is noted and appreciated.\n\nPlease continue following your Manager's instructions as normal.\n\nCase closed.\n\n- Security Team\n[Verified by Management ✓]`}
    };
