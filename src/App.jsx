...
const generateHackerName = () => {
  const p = ['Shadow','Cyber','Dark','Neo','Null','Zero','Ghost','Phantom','Void','Crypto','Neon','Crypto','Binary','Silent','Chaos','Rogue','Static','Glitch','Stealth','Vector','Quantum','Pixel','System','Root','Kernel','Stack','Buffer','Neural','Viral','Toxic','Chrome','Iron','Cobalt','Onyx','Crimson','Azure'];
  const c = ['Byte','Code','Hack','Cat','Net','Data','Bit','Kitten','Wire','Port','Node','Link','Pulse','Wave','Storm','Flux','Core','Surge','Ghost','Drift','Spike','Crash','Burn','Slash','Strike','Blade','Fang','Wolf','Hawk','Viper','Raven','Wraith','Specter','Daemon','Proxy','Cache','Hash','Cipher','Lock','Key'];
      ...
      <div className="crt-flicker w-full max-w-2xl">
        ...
        <div className="border-2 border-green-600 bg-black/80 p-4 mb-4">
          <div className="flex justify-between items-center">
            <span className="text-green-500 text-sm">SUNSHINE_COMM_v2.1</span>
...
const CertificateModal = ({ realName, hackerName, onClose }) => {
  ...
  useEffect(() => {
    ...
    ctx.fillStyle = '#f33'; ctx.font = 'bold 24px monospace'; ctx.fillText('PROJECT SUNSHINE', w/2, 575);
  ...
  const dl = () => {
    ...
    a.download = `SUNSHINE-CERT-${hackerName}.png`;
...
export default function App() {
  ...
  const TopNav = () => (
    <div className="fixed top-0 left-0 right-0 bg-gray-900 border-b-2 border-green-700 p-3 flex justify-between items-center z-40">
      <span className="text-green-500 text-base font-bold tracking-wider">PROJECT SUNSHINE // {hackerName}</span>
    ...
    return (
      <div className="min-h-screen bg-black text-green-400 font-mono p-6 flex flex-col items-center justify-center">
        <div className="text-center max-w-2xl">
          ...
          <h1 className="text-4xl md:text-5xl mb-3 tracking-widest animate-pulse font-bold">PROJECT SUNSHINE</h1>
          ...
          <div className="bg-gray-900 border-2 border-green-700 p-6 rounded-lg text-left mb-10">
            <p className="text-green-300 text-lg leading-relaxed">
              <TypeWriter text="INCOMING TRANSMISSION... Welcome, operative. You have been selected for a mandatory security training program. Don't worry - it will be fun. Educational. Nothing bad will happen. Your Security Director is waiting. - Anonymous" speed={25} />
            </p>
          </div>
      ...
      <div className="min-h-screen bg-black text-green-400 font-mono p-6 pt-20 flex flex-col items-center justify-center">
        ...
        <div className="text-center max-w-lg">
          ...
          <div className="bg-gray-900 border-2 border-yellow-700 p-6 rounded-lg mb-8 text-left">
            ...
            <p className="text-green-300 text-lg leading-relaxed">
              <TypeWriter text={`Well well well, ${hackerName}. You actually did it. Every system compromised. Every password extracted. All because someone in a mask told you it was "authorized." The skills you've learned are REAL. The vulnerabilities are REAL. The question is... what kind of person does that make you? Enjoy your certificate. You've earned it. - Your "Security Director"`} speed={20} />
            </p>
          </div>
